 ...
 * @constructor
 * @param
 * scene: XMLscene where the torus will be created
 * inner: radius of the inner part of the torus
 * outer: radius of the outer part of the torus
 * slices: number of slices used to draw the torus
 * loops: number of loops used to draw the torus
 */
